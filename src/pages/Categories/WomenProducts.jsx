...
export default function WomenProducts() {
  ...
  useEffect(() => {
    if (products.length > 0) {
      const femaleProducts = products.filter((p) => p.categoryType === "female");
      setWomenProducts(femaleProducts);
        ...
        <div className="lg:flex lg:gap-12 px-6 lg:px-12 py-12">
          ...
          <main className="flex-1">
            ...
            <div className={`${isFilterOpen ? 'hidden lg:block' : 'block'}`}>
               <div>
                <h1 className="text-3xl font-light text-gray-900 mb-5 text-center">Women's Collection</h1>
              </div>
